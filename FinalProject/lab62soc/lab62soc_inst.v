	lab62soc u0 (
		...
		.rand_export_export                   (<connected-to-rand_export_export>),                   //                   rand_export.export
		...
		.key_ghost_external_connection_export (<connected-to-key_ghost_external_connection_export>), // key_ghost_external_connection.export
		.i2c_serial_export_sda_in             (<connected-to-i2c_serial_export_sda_in>),             //             i2c_serial_export.sda_in
		.i2c_serial_export_scl_in             (<connected-to-i2c_serial_export_scl_in>),             //                              .scl_in
		.i2c_serial_export_sda_oe             (<connected-to-i2c_serial_export_sda_oe>),             //                              .sda_oe
		.i2c_serial_export_scl_oe             (<connected-to-i2c_serial_export_scl_oe>)              //                              .scl_oe
	);
